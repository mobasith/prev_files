...
//import com.example.monolithic_spring_security.service.CustomUserDetails;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/swagger-ui/**", "/h2-console/**","/api/authusers/validate/**")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
