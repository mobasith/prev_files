...
var names = ["basith", "sudeep", "jayesh", "chaithanya", "chethan"];
var marks = [90, 85, 80, 75];
console.log('names and marks:');
for (var i = 0; i < names.length; i++) {
    console.log("".concat(names[i], ":").concat(marks[i]));
}
function findavg(marks) {
    var sum = marks.reduce(function (acc, val) { return acc + val; }, 0);
    var avg = sum / marks.length;
    console.log("average marks:".concat(avg));
    return avg;
}
findavg(marks);
